...
<div class="pkp_helpers_clear">
	{fbvFormSection for="title" title="common.title" required=true}
		{fbvElement type="textarea" multilingual=true name="title" id="title" value=$title readonly=$readOnly maxlength="255" rows="2" rich=true class="titleRichContent" required=true}
	{/fbvFormSection}
</div>
<br>
{fbvFormSection title="common.abstract" for="abstract" required=$abstractsRequired}
	...
	{/if}
	{fbvElement type="textarea" multilingual=true name="abstract" id="abstract" value=$abstract rows="10" rich="extended" readonly=$readOnly wordCount=$wordCount}
{/fbvFormSection}
